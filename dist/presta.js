...
const categories = [
    ...
    { id: 607, id_parent: 2, name: "Мебель ", link_rewrite: "mebel-" },
    {
        ...
        id_parent: 2,
        name: "Старинные вещи ",
        link_rewrite: "starinnye-vesshi-"
    },
    {
        id: 609,
        id_parent: 2,
        name: "Картины и зеркала",
        link_rewrite: "kartiny-i-zerkala"
    },
    {
        id: 610,
        id_parent: 2,
        name: "Столовые приборы",
        link_rewrite: "stolovye-pribory"
    },
    ...
    { id: 612, id_parent: 2, name: "Часы", link_rewrite: "chasy" },
    {
        id: 684,
        id_parent: 2,
        name: "Продукты по заказу",
        link_rewrite: "produkty-po-zakazu"
    },
    ...
    },
    {
        ...
        id_parent: 124,
        rel: "spalni-krovati",
        name: "Комплекты для спальни",
        link_rewrite: "bedroom-suites"
    },
    {
        id: 182,
        id_parent: 125,
    ...
    },
    {
        ...
        rel: "stolovie-gruppi",
        name: "Столы и стулья",
        link_rewrite: "tables-and-chairs"
    },
    {
        id: 188,
        id_parent: 127,
    ...
    },
    {
        ...
        rel: "myagkaya-mebel",
        name: "Кресла",
        link_rewrite: "armchairs"
    },
    {
        id: 613,
        id_parent: 607,
        rel: "stulya",
        name: " Банкетки - пуфы - скамейки",
        link_rewrite: "banketki-pufy-skamejki"
    },
    {
        id: 614,
        id_parent: 607,
    ...
    },
    {
        ...
        rel: "konsoli",
        name: "Консоли ",
        link_rewrite: "konsoli-"
    },
    {
        id: 622,
        id_parent: 607,
        rel: "stoli",
        name: "Косметические столики",
        link_rewrite: "kosmeticheskie-stoliki"
    },
    {
        id: 623,
        id_parent: 607,
    ...
    },
    {
        ...
        link_rewrite: "spalnye-garnitury-"
    },
    {
        id: 625,
        id_parent: 607,
        rel: "myagkaya-mebel",
        name: "Угловой диван",
        link_rewrite: "uglovoj-divan"
    },
    {
        id: 626,
        id_parent: 607,
        rel: "myagkaya-mebel",
        name: "Мягкие комплекты ",
        link_rewrite: "myagkie-komplekty-"
    },
    {
        id: 627,
        id_parent: 607,
        rel: "myagkaya-mebel",
        name: "Кожаные комплекты ",
        link_rewrite: "kozhanye-komplekty-"
    },
    {
        id: 628,
        id_parent: 607,
    ...
    },
    {
        ...
        id_parent: 608,
        rel: "kartini",
        name: "Настенные гобелены",
        link_rewrite: "nastennye-gobeleny"
    },
    {
        id: 645,
        id_parent: 607,
    ...
    },
    {
        ...
        link_rewrite: "statuetki-figurki"
    },
    {
        id: 647,
        id_parent: 608,
    ...
    },
    {
        ...
        id_parent: 608,
        rel: "pechi-kamini",
        name: "Принадлежности камина",
        link_rewrite: "prinadlezhnosti-kamina"
    },
    {
        id: 651,
        id_parent: 608,
    ...
    },
    {
        ...
        id_parent: 609,
        rel: "kartini",
        name: "Графические работы",
        link_rewrite: "graficheskie-raboty"
    },
    {
        id: 654,
        id_parent: 609,
    ...
    },
    {
        ...
        rel: "posuda",
        name: "Тарелки",
        link_rewrite: "tarelki"
    },
    {
        id: 665,
        id_parent: 610,
        rel: "posuda",
        name: "Столовые сервизы",
        link_rewrite: "stolovye-servizy"
    },
    {
        id: 666,
        id_parent: 610,
    ...
    },
    {
        ...
        link_rewrite: "podvesnye-lyustry"
    },
    {
        id: 670,
        id_parent: 611,
    ...
    },
    {
        ...
        id_parent: 612,
        rel: "chasi",
        name: "Напольные, настольные часы",
        link_rewrite: "napolnye-nastolnye-chasy"
    },
    {
        id: 675,
        id_parent: 612,
        rel: "chasi",
        name: "Наручные, карманные часы",
        link_rewrite: "naruchnye-karmannye-chasy"
    },
    {
        id: 676,
        id_parent: 612,
...
class Presta {
    constructor(webServiceConfig) {
        ...
        this.getListWithValues = ({ collectionName, query = {}, collectionItemName }) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const { concurrency, concurrencyTimeout: timeout } = this.webservice.options;
            return yield Qed_1.default({
                items,
                concurrency,
                timeout,
                callback: (item) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                    return yield this.parseResourceItem({
                        collectionItemName: collectionItemName || this.getCollectionItemName(collectionName),
                        item,
                        id: item.id
                    });
                }),
        ...
        this._discountPrice = (price, id) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const prices = yield this.getGenericResource(collectionName, null, {
        ...
        this._toBoolean = data => Boolean(Number(data));
        ...
        this._getCachedCollection = (collection, cache = false, getItem) => (itemConfig) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return yield Promise.all(collection.map((_item) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                ...
                const response = yield this.getGenericResourceItem(Object.assign({}, itemConfig, { item }));
                if (cache) {
                    if (!cacheSource)
                        this._cache[itemConfig.collectionName] = {};
                    this._cache[itemConfig.collectionName][response.id] = response;
                }
                return response;
            })));
        });
        this._getAssociations = ({ categories, images, product_features, stock_availables }, id) => tslib_1.__awaiter(this, void 0, void 0, function* () {
            const parsedCategories = yield this._getCachedCollection(categories, true)({
                collectionName: "categories",
                collectionItemName: "category"
            });
            const parsedFeatures = yield this._getCachedCollection(product_features, true)({
                collectionName: "product_features"
            });
            const parsedFeatureValues = yield this._getCachedCollection(product_features, false, ({ id_feature_value }) => ({
                id: id_feature_value
            }))({
                collectionName: "product_feature_values"
            });
            const compoundFeatures = parsedFeatures.map((feature, index) => Object.assign({}, Object.assign({ id_feature_value: parsedFeatureValues[index].id }, parsedFeatureValues[index]), feature));
            return {
    ...
    resource(resourceName, resourcePath, query) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const url = this.webservice.makeURL(resourcePath, query);
            resourceName === resourcePath && console.log(url);
            const result = yield this.webservice.fetch(url);
    ...
    getGenericResource(collectionName, collectionItemName, query) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return yield Promise.all(collection.map(item => this.getGenericResourceItem({
                item,
                collectionName,
                collectionItemName
            })));
